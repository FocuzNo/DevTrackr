...
{
    /// <inheritdoc />
    public partial class InitialGoalsService : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    current_minutes = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_goals_user_id_deadline",
                table: "goals",
                columns: new[] { "user_id", "deadline" });
