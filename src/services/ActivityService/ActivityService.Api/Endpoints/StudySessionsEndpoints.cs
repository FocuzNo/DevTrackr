...
public sealed class LogStudySessionEndpoint(IAppMediator mediator, ICurrentUserService currentUserService)
...
public sealed class GetStudySessionsEndpoint(IAppMediator mediator, ICurrentUserService currentUserService)
    : EndpointWithoutRequest
{
    ...
    {
        var result = await mediator.SendAsync(
            new GetStudySessionsQuery(currentUserService.GetRequiredUserId()),
            cancellationToken);
...
public sealed class GetStudySessionByIdEndpoint(IAppMediator mediator, ICurrentUserService currentUserService)
    : EndpointWithoutRequest
{
    public override void Configure()
    {
    ...
    {
        var result = await mediator.SendAsync(
            new GetStudySessionByIdQuery(currentUserService.GetRequiredUserId(), Route<Guid>("id")),
            cancellationToken);
...
public sealed class GetStudySessionsByGoalEndpoint(IAppMediator mediator, ICurrentUserService currentUserService)
    : EndpointWithoutRequest
{
    public override void Configure()
    {
    ...
    {
        var result = await mediator.SendAsync(
            new GetStudySessionsByGoalQuery(currentUserService.GetRequiredUserId(), Route<Guid>("goalId")),
            cancellationToken);
...
public sealed class GetStudySessionsByDateRangeEndpoint(IAppMediator mediator, ICurrentUserService currentUserService)
    : EndpointWithoutRequest
{
    public override void Configure()
    {
